    ...
    <div className="col-md-6 col-xl-3 mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="100">
      ...
      <div className="card p-4 rounded-4 rounded-top-end-0 rounded-bottom-start-0 hover-lift hover-shadow-xl">
        ...
        <div className="width-6x height-6x position-relative flex-center mb-4">
          <svg
            className="position-absolute w-100 text-danger h-100 start-0 top-0"
          ...
          {/* Icon */}
          <i className="bx bx-layer position-relative text-white fs-2 lh-1"></i>
        </div>
        {/* Feature title */}
        <div className="mb-2">
          <h5 className="mb-0">Beginner and Casual Friendly</h5>
        </div>
        {/* Feature description */}
        <p className="mb-0">
          Bird watchers of all skill levels will find it easy to use Birdr. No knowledge of complicated
          observation protocols needed!
        </p>
      </div>
    </div>
  );
